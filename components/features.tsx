...
const Features = () => {
  return (
    <Wrapper className="flex flex-col items-center justify-center py-12 relative">
      <div
        id="features"
        className="hidden md:block absolute top-0 -right1/3 w-72 h-72 bg-primary rounded-full blur-[10rem] -z-10"
      />
      ...
      <Container>
        <div className="max-w-md mx-auto text-start md:text-center">
          ...
          <p className="text-muted-foreground mt-6">
            InFlow oferuje szeroki zakres funkcji, które zwiększają efektywność
            Twojej organizacji
          </p>
        </div>
      </Container>
